...
# MySQL Configuration
#-------------------------------------
backupMySQL=false #Backup MySQL databases?
sqlUser="SQL_Username" #MySQL Username
sqlPassword="SQL_Password" #MySQL Password
sqlHost="localhost" #Keep the 'localhost' if the SQL Server is local
sqlDB="SQL_Database" #MySQL Database Name
